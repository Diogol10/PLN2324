...
def consultar_conceitos(designacao):
    ...
    desig_pt = desig["desc"]["desc"]
    desig_en = desig["en"]
    desig_fr = desig.get("fr")
    desig_es = desig.get("es")
    desig_de = desig.get("de")

    return render_template("descricao.html", desig_pt=desig_pt, desig_en=desig_en, desig_es=desig_es, desig_de=desig_de,
                           desig_fr=desig_fr, designacao=designacao)
